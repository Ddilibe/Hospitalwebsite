namespace SmartERP.Accounts {
    export interface ContraVoucherRow {
        Id?: number;
        VNo?: string;
        Vtype?: string;
        VDate?: string;
    ...
    export namespace ContraVoucherRow {
        export const idProperty = 'Id';
        export const nameProperty = 'VNo';
        export const localTextPrefix = 'Accounts.ContraVoucher';
        export const deletePermission = 'Financial:Contra Voucher';
        export const insertPermission = 'Financial:Contra Voucher';
        export const readPermission = 'Financial:Contra Voucher';
        export const updatePermission = 'Financial:Contra Voucher';
