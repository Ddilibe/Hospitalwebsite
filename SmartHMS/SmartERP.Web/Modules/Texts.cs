    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SmartERP Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to SmartERP";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SmartERP Account";
                    ...
                    public static LocalText FormTitle = "Sign up for SmartERP";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle =  "SmartERP";
            public static LocalText Dashboard = "Dashboard";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText ContentDescription ="SmartERP";
            }
