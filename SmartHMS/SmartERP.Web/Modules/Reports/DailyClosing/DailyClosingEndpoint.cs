...
namespace SmartERP.Reports.Endpoints
{
    using Serenity;
    using Serenity.Data;
    ...
    using MyRepository = Repositories.DailyClosingRepository;
    using MyRow = Entities.DailyClosingRow;
    using Serenity.Abstractions;

    [Route("Services/Reports/DailyClosing/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
   
    public class DailyClosingController : ServiceEndpoint
    {
