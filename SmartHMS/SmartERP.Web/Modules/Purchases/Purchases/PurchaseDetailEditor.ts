...
namespace SmartERP.Purchases {
    ...
    export class PurchaseDetailEditor extends Serenity.Extensions.GridEditorBase<PurchaseDetailsRow> {
        ...
        protected getDialogType() { return PurchaseDetailEditDialog; }
        ...
        protected validateEntity(row: PurchaseDetailsRow, id: number) {
