...
namespace SmartERP.Purchases.Endpoints
{
    ...
    [Route("Services/Purchases/Purchases/[action]")]
    ...
    public class PurchasesController : ServiceEndpoint
    {
        ...
        public FileContentResult ListExcel(IDbConnection connection, ListRequest request, [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.PurchasesColumns), request.ExportColumns);

            return ExcelContentResult.Create(bytes, "PurchasesInvoicesList_" +
