...
namespace SmartERP.Masters.Entities
{
    ...
    [ConnectionKey("Default"), Module("Masters"), TableName("[dbo].[Locations]")]
    [DisplayName("Locations"), InstanceName("Locations")]
  
    [ReadPermission(PermissionKeys.Locations.View)]
    [InsertPermission(PermissionKeys.Locations.Create)]
    [UpdatePermission(PermissionKeys.Locations.Update)]
    [DeletePermission(PermissionKeys.Locations.Delete)]

    [LookupScript("Masters.Locations", Permission = PermissionKeys.Locations.View)]
    public sealed class LocationsRow : SmartERP.LoggingRow<LocationsRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Longitude"), Size(250)]
