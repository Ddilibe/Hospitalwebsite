...
namespace SmartERP.Suppliers.Repositories
{
    using Serenity;
    using Serenity.Data;
    ...
    public class SuppliersRepository : BaseRepository
    {
        ...
        public SuppliersRepository(IRequestContext context)
            : base(context)
        {
        }
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow>
        {
            ...
            protected override void ValidateFieldValues()
            {
                ...
                if (IsCreate && !String.IsNullOrEmpty(Request.Entity.Phone))
                {
                    ...
                    if (row.Id > 0)
                    {
                        throw new Exception("Duplicate Contact number found (" + row.CompanyName + ")");
                    }
                }
            }
        }
