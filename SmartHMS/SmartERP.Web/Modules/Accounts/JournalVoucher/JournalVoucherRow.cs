...
namespace SmartERP.Accounts.Entities
{
    ...
    [DisplayName("Journal Voucher"), InstanceName("Journal Voucher")]
    [ReadPermission(Financial.PermissionKeys.JournalVoucher)]
    [ModifyPermission(Financial.PermissionKeys.JournalVoucher)]
