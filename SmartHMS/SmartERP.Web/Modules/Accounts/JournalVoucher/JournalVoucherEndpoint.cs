...
namespace SmartERP.Accounts.Endpoints
{
    ...
    using MyRepository = Repositories.JournalVoucherRepository;
    using MyRow = Entities.JournalVoucherRow;
    using Serenity.Abstractions;

    [Route("Services/Accounts/JournalVoucher/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
   
    public class JournalVoucherController : ServiceEndpoint
    {
