...
namespace SmartERP.Accounts.Entities
{
    ...
    [DisplayName("Bank Transactions"), InstanceName("Bank Transactions")]
    [ReadPermission(CashBank.PermissionKeys.BankTransactions)]
    [ModifyPermission(CashBank.PermissionKeys.BankTransactions)]
    public sealed class BankTransactionsRow : Row<BankTransactionsRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Withdraw / Deposite ID"), Size(50), NotNull, QuickSearch,NameProperty]
        public String VNo
        {
        ...
        [DisplayName("Bank"), Column("COAId"), NotNull,PrimaryKey, ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        [LookupInclude, LookupEditor(typeof(Lookups.AccountsBanksLookup), AutoComplete = true)]
        public Int64? CoaId
        {
        ...
        [DisplayName("Description"), Size(2147483647), NotNull]
