...
namespace SmartERP.Accounts.Repositories
{
    ...
    using System;
    using System.Data;
    using MyRow = Entities.BankTransactionsRow;

    public class BankTransactionsRepository : BaseRepository
    {
        private static MyRow.RowFields Fld => MyRow.Fields;
        
        public BankTransactionsRepository(IRequestContext context)
            : base(context)
        {
        ...
        private class MyListHandler : ListRequestHandler<MyRow>
        {
            ...
            protected override void OnBeforeExecuteQuery()
            {
                ...
                Query.Where(
                    new Criteria(Fld.Coa).StartsWith("1020204") &
