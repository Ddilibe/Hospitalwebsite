...
namespace SmartERP.Accounts.Entities
{
    ...
    [DisplayName("Contra Voucher"), InstanceName("Contra Voucher")]
    [ReadPermission(Financial.PermissionKeys.ContraVoucher)]
    [ModifyPermission(Financial.PermissionKeys.ContraVoucher)]
    public sealed class ContraVoucherRow : Row<ContraVoucherRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Account"), Column("COAId"), NotNull, ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        ...
        public ContraVoucherRow()
        {
        }

        public ContraVoucherRow(RowFields fields)
            : base(fields)
        {
        }
