...
namespace SmartERP.Accounts.Endpoints
{
    ...
    using MyRepository = Repositories.CustomerReceiveRepository;
    using MyRow = Entities.CustomerReceiveRow;
    using Serenity.Abstractions;

    [Route("Services/Accounts/CustomerReceive/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
  
    public class CustomerReceiveController : ServiceEndpoint
    {
