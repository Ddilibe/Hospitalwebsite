namespace SmartERP.Lookups
{
    ...
    [LookupScript]
    public class AccountsCustomerLookup : RowLookupScript<AccountsRow>
    {
        public AccountsCustomerLookup(ISqlConnections sqlConnections)
            : base(sqlConnections)
        {
        ...
        protected override void PrepareQuery(SqlQuery query)
        {
            ...
            query.Distinct(true)
                ...
                .Where(
                    new Criteria(fld.CustomerId) > 0//.StartsWith("50204") &
                                                    //new Criteria(fld.HeadCode)!= 50204 &
