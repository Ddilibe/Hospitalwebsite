...
namespace SmartERP.Accounts.Endpoints
{
    ...
    using MyRepository = Repositories.CreditVoucherRepository;
    using MyRow = Entities.CreditVoucherRow;
    using Serenity.Abstractions;

    [Route("Services/Accounts/CreditVoucher/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
  
    public class CreditVoucherController : ServiceEndpoint
    {
