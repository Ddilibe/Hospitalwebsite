...
namespace SmartERP.Accounts.Entities
{
    ...
    [DisplayName("Credit Voucher"), InstanceName("Credit Voucher")]
    [ReadPermission(Financial.PermissionKeys.CreditVoucher)]
    [ModifyPermission(Financial.PermissionKeys.CreditVoucher)]
    public sealed class CreditVoucherRow : Row<CreditVoucherRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Debit Account Head"), Column("COAId"), NotNull, ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        ...
        [NotMapped]
        [DisplayName("Account"), Column("CreditAccountId"), NotNull, ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCoaCredit"), TextualField("CoaHeadName")]
        //[LookupInclude, LookupEditor(typeof(AccountsRow), AutoComplete = true)]
        [LookupInclude, LookupEditor(typeof(Lookups.AccountsCashLookup), AutoComplete = true)]
        public Int64? CreditAccountId
        {
        ...
        public CreditVoucherRow()
        {
        }

        public CreditVoucherRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int64Field CreditAccountId;
