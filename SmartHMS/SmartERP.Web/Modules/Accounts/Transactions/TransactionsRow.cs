...
namespace SmartERP.Accounts.Entities
{
    ...
    [ReadPermission(Financial.PermissionKeys.Transactions)]
    [ModifyPermission(Financial.PermissionKeys.Transactions)]
    public sealed class TransactionsRow : Row<TransactionsRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("V No"), Size(50), NotNull, QuickSearch,NameProperty]
        public String VNo
        {
        ...
        [DisplayName("Vtype"), Size(50), NotNull]
        public String Vtype
        {
        ...
        [DisplayName("Coa"), Column("COAId"), NotNull, PrimaryKey, ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        public Int64? CoaId
        {
        ...
        [DisplayName("Coa"), Column("COA"), Size(50), NotNull]
        public String Coa
        {
        ...
        public TransactionsRow(RowFields fields)
            : base(fields)
        {
        }
