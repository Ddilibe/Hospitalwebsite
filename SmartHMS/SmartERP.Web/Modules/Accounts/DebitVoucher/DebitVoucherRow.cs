...
namespace SmartERP.Accounts.Entities
{
    ...
    [DisplayName("Debit Voucher"), InstanceName("Debit Voucher")]
    [ReadPermission(Financial.PermissionKeys.DebitVoucher)]
    [ModifyPermission(Financial.PermissionKeys.DebitVoucher)]
    public sealed class DebitVoucherRow : Row<DebitVoucherRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Credit Account Head"), Column("COAId"), NotNull,PrimaryKey, ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        //[LookupInclude, LookupEditor(typeof(AccountsRow), AutoComplete = true)]
        ...
        [NotMapped]
        [DisplayName("Account"), Column("DebitAccountId"), NotNull,PrimaryKey, ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCoaDebit"), TextualField("CoaHeadName")]
        //[LookupInclude, LookupEditor(typeof(AccountsRow), AutoComplete = true)]
        [LookupInclude, LookupEditor(typeof(Lookups.AccountsCashLookup), AutoComplete = true)]
        public Int64? DebitAccountId
        {
        ...
        public DebitVoucherRow()
        {
        }

        public DebitVoucherRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int64Field DebitAccountId;
