...
namespace SmartERP.Accounts.Entities
{
    ...
    [DisplayName("Cash Adjustment"), InstanceName("Cash Adjustment")]
    [ReadPermission(CashBank.PermissionKeys.CashAdjustment)]
    [ModifyPermission(CashBank.PermissionKeys.CashAdjustment)]
    public sealed class CashAdjustmentRow : Row<CashAdjustmentRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Adjustment Type"), NotMapped]
        public AccountKind? AccountType
        {
            get { return (AccountKind?)Fields.AccountType[this]; }
            set { Fields.AccountType[this] = (Int32)value; }
        }
        [DisplayName("Coa"), Column("COAId"), ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCoa"), TextualField("CoaHeadName")]
        public Int64? CoaId
        {
        ...
        [DisplayName("Remark"), Size(2147483647), NotNull]
        ...
        public CashAdjustmentRow()
        {
        }

        public CashAdjustmentRow(RowFields fields)
            : base(fields)
        {
        }
