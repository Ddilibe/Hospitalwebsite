...
namespace SmartERP.Accounts.Endpoints
{
    ...
    using MyRepository = Repositories.CashAdjustmentRepository;
    using MyRow = Entities.CashAdjustmentRow;
    using Serenity.Abstractions;

    [Route("Services/Accounts/CashAdjustment/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class CashAdjustmentController : ServiceEndpoint
    {
