...
namespace SmartERP.Accounts.Endpoints
{
    ...
    using MyRepository = Repositories.OpeningBalanceRepository;
    using MyRow = Entities.OpeningBalanceRow;
    using Serenity.Abstractions;

    [Route("Services/Accounts/OpeningBalance/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    
    public class OpeningBalanceController : ServiceEndpoint
    {
