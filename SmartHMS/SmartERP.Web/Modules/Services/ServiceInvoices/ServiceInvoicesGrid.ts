...
namespace SmartERP.Services {
    ...
    export class ServiceInvoicesGrid extends Serenity.EntityGrid<ServiceInvoicesRow, any> {
        protected getColumnsKey() { return 'Services.ServiceInvoices'; }
        protected getDialogType() { return ServiceInvoicesDialog; }
        ...
        protected getButtons() {
            ...
            buttons.push(Serenity.Extensions.ExcelExportHelper.createToolButton({
                grid: this,
                service: ServiceInvoicesService.baseUrl + '/ListExcel',
