...
namespace SmartERP.Sales.Endpoints
{
    using Serenity;
    using Serenity.Data;
    ...
    public class SalesController : ServiceEndpoint
    {
        ...
        public FileContentResult ListExcel(IDbConnection connection, ListRequest request, [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.SalesColumns),request.ExportColumns);

            return ExcelContentResult.Create(bytes, "SalesList_" +
