...
namespace SmartERP.Sales.Repositories
{
    using Serenity;
    using Serenity.Data;
    ...
    public class SalesRepository : BaseRepository
    {
        ...
        public SalesRepository(IRequestContext context)
            : base(context)
        {
        }
        ...
        private class MySaveHandler : SaveRequestHandlerWithRowVersion<MyRow>
        {
            ...
            protected override void AfterSave()
            {
                ...
                {
                    string cmd = "UPDATE [dbo].[SaleDetails] SET [IsActive]=-1 , [UpdateDate]=GETDATE(),[UpdateUserId]='"+ Row .UpdateUserId+ "' WHERE [SaleId]='" + Row.Id+"'";
